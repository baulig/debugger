...
typedef enum {
	...
	CMD_EXE_READER_GET_BASE_ADDRESS = 8,
	CMD_EXE_READER_GET_END_ADDRESS = 9,
	CMD_EXE_READER_GET_ENTRY_POINT = 10
} CmdExeReader;

typedef enum {
	CMD_PROCESS_INITIALIZE_PROCESS = 1,
	CMD_PROCESS_GET_MAIN_READER = 2,
	CMD_PROCESS_SPAWN = 3,
	CMD_PROCESS_ATTACH = 4,
	CMD_PROCESS_SUSPEND = 5,
	CMD_PROCESS_RESUME = 6,
	CMD_PROCESS_GET_ALL_THREADS = 7,
	CMD_PROCESS_GET_MONO_RUNTIME = 8,
	CMD_PROCESS_GET_ALL_MODULES = 9
} CmdProcess;
...
typedef enum {
	...
	CMD_MONO_RUNTIME_GET_LMF_ADDRESS = 4
} CmdMonoRuntime;
